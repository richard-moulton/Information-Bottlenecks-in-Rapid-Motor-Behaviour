# Jags-Ymet-Xnom1grp-Mnormal-OHOHA.R 
# Based on code accompanying the book:
#   Kruschke, J. K. (2015). Doing Bayesian Data Analysis, Second Edition: 
#   A Tutorial with R, JAGS, and Stan. Academic Press / Elsevier.
# Adapted for steady-state rate specific analysis for the OH family of tasks.
